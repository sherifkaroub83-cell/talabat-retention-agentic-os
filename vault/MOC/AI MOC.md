...
- [[Personalization]] — the customer-experience/business-impact framing (the ~6-order threshold to build a customer profile)
- [[Recommendation Systems]] — the specific technical mechanism (item-level vs. cuisine-level ranking, "Meal for One")
- [[Advertising]] — AI-driven ad-targeting and automated ad-buying, a distinct monetization application of the same ML capability

## Where AI meets retention
- [[Customer Retention]] — machine learning explicitly times loyalty-programme offers (talabat pro, talabat rewards) "at the right time for customers"
...
- [[Customer MOC]] — the retention/CLV side this technology serves
