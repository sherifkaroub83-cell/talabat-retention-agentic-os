...
**Current status:** 6 rows populated (ASM-001–004 from Section 3's Pilot 1 run, 2026-07-22; ASM-005
from Section 2's Pilot 2 run, 2026-07-22; ASM-006 from the Section 9 hand-off run, 2026-07-22 — see
`vault/Architecture/Pilot_Validation_Plan.md`).
