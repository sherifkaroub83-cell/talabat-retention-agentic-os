...
AI application is a conventional ML/ranking system, not an agentic architecture (`Facts/AI_Facts.md`,
`Topics/AI.md` — no MCP/agentic/LLM reference in either consolidated note; independently verified by a
vault-wide grep sweep during this section's citation audit). This plan's own
