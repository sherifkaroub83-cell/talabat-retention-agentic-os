...
Python is now installed locally; `scripts/build_final_publication.py` was re-run directly against the
corrected `Business_Plan_Drafts_v2/`, restoring a canonical **25-page** PDF (confirming the 31-page
figure above was a Word rendering-engine artifact). Corrected wording verified present via direct PDF
text extraction; stale figure confirmed absent. This rebuilt file ships; the Word-COM-produced version
above is superseded.
